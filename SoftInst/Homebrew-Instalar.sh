...
# ----------
# Script de NiPeGun para instalar y configurar HomeBrew en macOS
#
# Ejecución remota:
#  curl -sL https://raw.githubusercontent.com/nipegun/m-scripts/master/SoftInst/ParaCLI/HomeBrew-InstalarYConfigurar.sh | bash
#
# Ejecución remota sin caché:
#  curl -sL -H 'Cache-Control: no-cache, no-store' https://raw.githubusercontent.com/nipegun/m-scripts/master/SoftInst/ParaCLI/HomeBrew-InstalarYConfigurar.sh | bash
#
# Ejecución remota con parámetros:
#  curl -sL https://raw.githubusercontent.com/nipegun/m-scripts/master/SoftInst/ParaCLI/HomeBrew-InstalarYConfigurar.sh | bash -s Parámetro1 Parámetro2
# ----------
...
# Elegir que hacer según la versión de macOS
  ...
  if [ $cVerSO == "15" ]; then
    ...
    # Reparar permisos
      sudo chmod 777 /usr/local/share/man/es/man1
